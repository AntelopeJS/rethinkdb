...
function handleMap(
  ...
  return [
    TermType.MAP,
    [prev, [TermType.FUNC, [[TermType.MAKE_ARRAY, [argId]], body]]],
  ];
}

function handleMapSingle(
  prev: TermJson,
  stage: QueryStage,
  context: DecodingContext,
): TermJson {
...
function handleJoin(
  ...
  const predicateTerm: TermJson = [
    TermType.FUNC,
    [[TermType.MAKE_ARRAY, [predArgId, predArgId2]], predBody],
  ];
  ...
  const mapperTerm: TermJson = [
    TermType.FUNC,
    [[TermType.MAKE_ARRAY, [mapArgId]], mapBody],
  ];
...
function handleGroup(
  ...
  const mapperFunc: TermJson = [
    TermType.FUNC,
    [[TermType.MAKE_ARRAY, [mapArgId]], body],
  ];
...
function handleSlice(
  ...
  const count =
    stage.args[1] !== undefined
      ? DecodeValue(stage.args[1], context)
      : undefined;
